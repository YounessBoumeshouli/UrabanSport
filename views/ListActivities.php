...
ob_start();
?>
<div class="flex justify-center items-center text-white mt-10 h-16"><button>Add Activity</button></div>
    <div class="mt-8">
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white">
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-500"><a href="" class="text-indigo-600 hover:text-indigo-900">reserve equipement</a></td>
